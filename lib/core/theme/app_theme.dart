    ...
    return ThemeData(
      ...
      inputDecorationTheme: InputDecorationTheme(
        ...
        labelStyle: TextStyle(
          color: brightness == Brightness.dark ? AppColors.textSecondary : const Color(0xFF525252),
        ),
        hintStyle: TextStyle(
          color: brightness == Brightness.dark ? AppColors.textMuted : const Color(0xFF737373),
        ),
      ),
    );
  }

...
final appSettingsPanelDesignProvider =
    StateNotifierProvider<
      AppSettingsPanelDesignNotifier,
      AppSettingsPanelDesign
    >((ref) {
      return AppSettingsPanelDesignNotifier(ref.watch(appPrefsProvider));
    });

class AppSettingsPanelDesignNotifier
    extends StateNotifier<AppSettingsPanelDesign> {
  AppSettingsPanelDesignNotifier(this._prefs) : super(_read(_prefs));

  final AppPrefs _prefs;

  static AppSettingsPanelDesign _read(AppPrefs p) {
    return AppSettingsPanelDesignStorage.fromStorage(
      p.getString(_kPanelDesignKey),
    );
  }

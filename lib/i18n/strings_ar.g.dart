...
class _TranslationsLoginAr extends TranslationsLoginEn {
	...
	@override String get passkey_cta => 'المتابعة بمفتاح المرور';
	@override String get passkey_preparing => 'جارٍ تحضير تسجيل الدخول الآمن…';
	@override String get passkey_canceled => 'تم إلغاء تسجيل الدخول بمفتاح المرور.';
	@override String get passkey_not_found => 'لا يوجد مفتاح مرور لـ Wayo على هذا الجهاز. استخدم طريقة أخرى أو أنشئ مفتاح مرور بعد تسجيل الدخول.';
	@override String get passkey_unavailable => 'مفاتيح المرور غير متاحة على هذا الجهاز.';
	@override String get passkey_network => 'خطأ في الشبكة. تحقق من اتصالك وحاول مجددًا.';
	@override String get passkey_failed => 'تعذر تسجيل الدخول بهذا المفتاح. حاول مجددًا أو استخدم طريقة أخرى.';
...
class _TranslationsAppSettingsAr extends TranslationsAppSettingsEn {
	...
	@override String get passkeys_manage_hint => 'استخدم مفاتيح المرور لتسجيل الدخول بسرعة وبدون كلمة مرور.';
	@override String get passkeys_open_manage => 'إدارة مفاتيح المرور';
	@override String get passkeys_empty => 'لا توجد مفاتيح مرور مُعدّة.';
	@override String get passkeys_count_one => 'مفتاح مرور واحد';
	@override String passkeys_count_many({required Object count}) => '$count مفاتيح مرور';
	@override String get passkeys_add => 'إضافة مفتاح مرور';
	@override String get passkeys_rename => 'إعادة تسمية';
	@override String get passkeys_remove => 'إزالة';
	@override String get passkeys_remove_title => 'إزالة مفتاح المرور هذا؟';
	@override String get passkeys_remove_body => 'لن يمكن استخدام مفتاح المرور هذا لتسجيل الدخول إلى Wayo بعد الآن.';
	@override String get passkeys_remove_confirm => 'إزالة';
	@override String get passkeys_remove_cancel => 'إلغاء';
	@override String passkeys_created({required Object date}) => 'أُنشئ في $date';
	@override String passkeys_last_used({required Object date}) => 'آخر استخدام: $date';
	@override String get passkeys_never_used => 'لم يُستخدم';
	@override String get passkeys_rename_title => 'إعادة تسمية مفتاح المرور';
	@override String get passkeys_default_name => 'مفتاح مرور';
	@override String get passkeys_promote_title => 'فعّل تسجيل الدخول بمفتاح مرور';
	@override String get passkeys_promote_body => 'سجّل الدخول بسرعة أكبر ببصمة الإصبع أو الوجه أو قفل الجهاز.';
	@override String get passkeys_promote_create => 'إنشاء مفتاح مرور';
	@override String get passkeys_promote_later => 'ليس الآن';
	@override String get passkeys_created_ok => 'تمت إضافة مفتاح المرور';
	@override String get passkeys_error => 'حدث خطأ. حاول مجددًا.';
	@override String get passkeys_already_title => 'مفتاح المرور متاح بالفعل';
	@override String get passkeys_already_body => 'مفتاح مرور Wayo مسجّل بالفعل على هذا الجهاز أو لدى مزوّد بيانات الاعتماد. يظهر في القائمة أعلاه. لإضافة مفتاح آخر، استخدم مزوّدًا مختلفًا.';
	@override String get passkeys_already_action => 'حسنًا';
	@override String get passkeys_limit_reached => 'وصلت إلى الحد الأقصى لمفاتيح المرور لهذا الحساب.';
	@override String get passkeys_last_lockout => 'مفتاح المرور هذا هو حالياً آخر طريقة تسجيل دخول متاحة. أضف طريقة أخرى قبل حذفه.';
	@override String get passkeys_security_entry => 'مفاتيح المرور';
	@override String get passkeys_security_sub => 'تسجيل دخول بدون كلمة مرور';
...
class _TranslationsAdvertiserCampaignsCreateAr extends TranslationsAdvertiserCampaignsCreateEn {
	...
	@override String get logo_section => 'شعار العلامة (اختياري)';
	@override String get logo_pick => 'رفع شعار العلامة';
	@override String get logo_change => 'تغيير';
	@override String get logo_remove => 'إزالة';
	@override String get logo_reposition => 'إعادة التموضع';
	@override String get logo_uploading => 'جارٍ الرفع…';
	@override String get logo_help => 'يُفضل صورة أفقية (16:9)، 1920×1080 بكسل كحد أدنى. تظهر كشعار رئيسي على صفحة حملتك. PNG أو JPG أو WebP. الحد الأقصى 2 ميغا.';
	@override String get logo_too_large => 'يجب أن يكون الشعار 2 ميغا أو أقل.';
	@override String get logo_upload_error => 'فشل رفع الشعار';
	@override String get logo_pick_error => 'تعذّر قراءة الصورة المحددة';
	@override String get logo_crop_title => 'ضع صورة حملتك';
	@override String get logo_crop_desc => 'اسحب وكبّر لإبقاء الجزء المهم داخل إطار 16:9.';
	@override String get logo_crop_zoom => 'تكبير';
	@override String get logo_crop_hint => 'ما تراه في الإطار هو ما سيراه المنشئون على صفحة الحملة وفي التصفح.';
	@override String get logo_crop_cancel => 'إلغاء';
	@override String get logo_crop_apply => 'تطبيق القص';
	@override String get logo_crop_applying => 'جارٍ الحفظ…';
	@override String get logo_crop_failed => 'تعذّر قص هذه الصورة. جرّب ملفًا آخر.';
...
extension on TranslationsAr {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'login.passkey_cta': return 'المتابعة بمفتاح المرور';
			case 'login.passkey_preparing': return 'جارٍ تحضير تسجيل الدخول الآمن…';
			case 'login.passkey_canceled': return 'تم إلغاء تسجيل الدخول بمفتاح المرور.';
			case 'login.passkey_not_found': return 'لا يوجد مفتاح مرور لـ Wayo على هذا الجهاز. استخدم طريقة أخرى أو أنشئ مفتاح مرور بعد تسجيل الدخول.';
			case 'login.passkey_unavailable': return 'مفاتيح المرور غير متاحة على هذا الجهاز.';
			case 'login.passkey_network': return 'خطأ في الشبكة. تحقق من اتصالك وحاول مجددًا.';
			case 'login.passkey_failed': return 'تعذر تسجيل الدخول بهذا المفتاح. حاول مجددًا أو استخدم طريقة أخرى.';

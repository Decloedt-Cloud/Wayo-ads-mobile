...
class Translations implements BaseTranslations<AppLocale, Translations> {
	...
	late final TranslationsCookiePolicyEn cookie_policy = TranslationsCookiePolicyEn.internal(_root);
...
class TranslationsLoginEn {
	...
	String get passkey_cta => 'Continue with passkey';
	String get passkey_preparing => 'Preparing secure sign-in…';
	String get passkey_canceled => 'Passkey sign-in cancelled.';
	String get passkey_not_found => 'No passkey found for Wayo on this device. Use another sign-in method or create a passkey after signing in.';
	String get passkey_unavailable => 'Passkeys aren\'t available on this device.';
	String get passkey_network => 'Network error. Check your connection and try again.';
	String get passkey_failed => 'We couldn\'t sign you in with this passkey. Try again or use another sign-in method.';
	String get passkey_interrupted => 'Sign-in was interrupted. Please try again.';
	String get passkey_missing_title => 'No Wayo Ads passkey';
	String get passkey_missing_body => 'You haven\'t set up a passkey for this account yet. Sign in with Google, Apple or your password, then enable a passkey from Profile → Security → Passkeys.';
	String get passkey_missing_primary => 'Use another method';
	String get passkey_missing_secondary => 'Cancel';
	String get passkey_created_title => 'Passkey added';
	String get passkey_created_body => 'You can now use this passkey to sign in to your Wayo account.';
	String get passkey_created_action => 'Got it';
	...
	String get web_session_title => 'Account Already Active';
	String get web_session_body => 'This account is already active on another device. Do you want to disconnect the other device and sign in here?';
	String get web_session_disconnect => 'Disconnect Other Device';
	String get web_session_disconnecting => 'Disconnecting…';
...
class TranslationsPrivacyPolicyEn {
	...
	String get company_legal_name => 'AL BOUHOUTI SOFTWARE DESIGN COMPANY L.L.C';
	String get operator_intro => 'This website and the Wayo Ads platform are operated by:';
	String get company_address => 'Al Barshaa 1, Dubai, Dubai, United Arab Emirates';
	String get support_label => 'Customer support';
	String get support_email => 'support@wayo.cloud';
	String get support_phone => '+971 542396643';
	String get intro_title => '1. Introduction';
	String get intro_body => 'At Wayo Ads, we are committed to collecting and using your data responsibly, in compliance with applicable data protection laws in the jurisdictions where we operate, including U.S. federal and state law where relevant, and, where applicable to users in the EEA or UK, the GDPR (EU 2016/679). By using our platform, you agree to the collection, processing, and use of your data as described in this privacy policy.';
	String get data_title => '2. Data We Collect';
	String get data_intro => 'We only collect data that is necessary, in accordance with applicable law and, where relevant, the GDPR.';
	String get data_advertisers_title => 'For Advertisers';
	String get data_advertisers_body => 'Identification and contact data: Company name, email address, phone number.\nProfile: Business logo (if provided), company description.\nCampaigns: Campaign content, budgets, targeting criteria, analytics data.';
	String get data_creators_title => 'For Creators';
	String get data_creators_body => 'Identification and contact data: Name, email address, phone number.\nProfile: Profile photo (if provided), biography, expertise, social media links.\nContent: Videos, posts, and materials you upload.\nUsage data: Interactions with the platform, engagement statistics, earnings data.';
	String get data_technical_title => 'Technical Information (All Users)';
	String get data_technical_body => 'Technical data: IP address, browser type and version, device type, operating system, session identifiers, timestamps, pages visited, clicks, referrers.\nCookies and similar technologies: See section 8 (Cookies).';
	String get data_payment_title => 'Payment Data';
	String get data_payment_body => 'Transactions: Amounts, currency, date, payment method, billing address.';
	String get data_payment_note => 'Important: Card data is processed exclusively by our payment provider (Stripe). Wayo does not store credit card information.';
	String get purpose_title => '3. Purpose of Using Your Data';
	String get purpose_body => 'We use your data to: Provide, maintain, and improve our services. Personalize the experience and recommend relevant content. Manage contractual relationships (accounts, billing, support). Communicate service information (updates, changes, alerts). Ensure platform security and integrity (abuse/fraud detection). Perform usage analysis with aggregated or anonymized data whenever possible.';
	String get legal_bases_title => '4. Legal Bases for Processing';
	String get legal_bases_body => 'Depending on the case, we rely on: Your consent (e.g., non-essential cookies, newsletters). Performance of a contract or pre-contractual measures (e.g., registration, billing). Compliance with a legal obligation (e.g., invoice retention). Our legitimate interest (e.g., security, service improvement).';
	String get sharing_title => '5. Sharing Your Information';
	String get sharing_body => 'Wayo does not sell your personal data. Limited sharing may occur with: Essential service providers (payment processors, hosting providers, emailing tools, analytics). Legal reasons: If required by law or in response to a legitimate request from a competent authority.';
	String get security_title => '6. Data Security';
	String get security_body => 'TLS/HTTPS encryption for data in transit.\nAccess controls based on need-to-know.\nRegular backups and restoration procedures.\nSecurity updates and periodic audits.\nLogging and detection of abnormal activities.';
	String get content_title => '7. User Responsibilities and Content Protection';
	String get content_body => 'Respect the intellectual property rights of creators and Wayo. Do not copy, share, redistribute, or resell content without authorization. Any violation may result in account suspension and, if applicable, legal action.';
	String get cookies_title => '8. Cookies and Tracking Technologies';
	String get cookies_body => 'Essential cookies (site functionality, security, session).\nAnalytical cookies (e.g., Google Analytics) for audience measurement.\nNon-essential cookies are only set with your consent via a cookie banner on your first visit.';
	...
	String get contact_controller_label => 'Data Controller';
	String get contact_controller => 'Wayo, Dubai, UAE';
	String get contact_email_label => 'Email';
	String get contact_email => 'info@wayo.cloud';
	String get contact_address_label => 'Address';
	String get contact_address => 'R320 Umm Hurair 2, Dubai, UAE';
}

// Path: terms_and_conditions
class TranslationsTermsAndConditionsEn {
	TranslationsTermsAndConditionsEn.internal(this._root);
	...
	String get intro_title => '1. Introduction';
	String get intro_body => 'Welcome to Wayo Ads, your online platform connecting advertisers with content creators. By accessing our website and/or mobile application, you agree to comply with these terms and conditions. Please read them carefully, as they define your rights and obligations as a user.';
	String get definitions_title => '2. Definitions';
	String get definitions_body => 'Wayo — The entire set of advertising and creator marketplace services available through the website and mobile application.\nUser — Any person (advertiser, creator, or organization) holding an account on the platform.\nContent — All documents, videos, advertisements, campaigns, and other materials accessible via the platform.\nUsage rights — Access and use rights to the content are strictly personal, private, and non-transferable.';
	String get access_title => '3. Access and Use';
	String get access_body => 'The user must create an account by providing accurate and up-to-date information. The user is responsible for keeping their login details confidential. Any unauthorized use must be reported immediately.';
	String get content_protection_title => '4. Content Protection and Use';
	String get content_protection_body => 'All materials and content remain the intellectual property of their respective owners. Reproduction, distribution, sale, or sharing of content is strictly prohibited. Any violation will result in immediate suspension of the account and may lead to legal action.';
	String get features_title => '5. Features and Services';
	String get features_body => 'Our platform offers various features including campaign creation, creator marketplace, analytics dashboards, payment processing, and communication tools. Users agree to use these services responsibly and in accordance with these terms.';
	String get support_title => '6. Technical Support and Maintenance';
	String get support_body => 'Support is available Monday to Friday, from 9:00 AM to 5:00 PM (UTC+1) via email or integrated chat. Estimated response time is 24 to 48 hours. Users will be notified in advance of any scheduled downtime.';
	String get rights_title => '7. User Rights and Responsibilities';
	String get rights_body => 'Advertisers have the right to create and manage campaigns, access analytics, and connect with creators. Creators have the right to browse campaigns, accept offers, and receive payment for completed work. All users must act in good faith and comply with platform rules.';
	String get prohibited_title => 'Prohibited Behavior';
	String get prohibited_body => 'Fraud (e.g., fake views, click fraud), illegal, offensive, or harmful content, spamming, impersonation, and any activity that undermines the integrity of the platform are strictly prohibited. Any breach may result in permanent suspension and legal action.';
	String get ip_title => '8. Intellectual Property';
	String get ip_body => 'All trademarks, logos, designs, code, and other intellectual property on the platform are protected by copyright law and international conventions. Users retain ownership of content they create but grant Wayo a non-exclusive license to host, display, and make it accessible.';
	String get privacy_title => '9. Personal Data';
	String get privacy_body => 'The collection and processing of data are carried out in accordance with our Privacy Policy. Users have the right to access, correct, and delete their personal data. For more information, please review our Privacy Policy.';
	String get view_privacy_policy => 'View Privacy Policy';
	String get liability_title => '10. Limitation of Liability';
	String get liability_body => 'Wayo shall not be held responsible for: the quality or relevance of content provided by users, disputes between advertisers and creators, service interruptions, data loss, or technical issues. Wayo\'s liability is limited to the amount of fees paid for the service.';
	String get termination_title => '11. Termination';
	String get termination_body => 'Wayo may suspend or terminate an account in case of violation of these terms. Users may close their account through the platform interface at any time. Upon termination, all rights and access will be immediately revoked.';
	String get governing_law_title => '12. Governing Law and Dispute Resolution';
	String get governing_law_body => 'Governing law: The laws in force in the United Arab Emirates. Both parties agree to seek amicable resolution before initiating legal proceedings.';
	String get amendments_title => '13. Amendments to the Terms';
	String get amendments_body => 'Wayo may modify these terms at any time. Users will be notified of any changes, which will take effect 15 days after notification.';
	String get waiver_title => '14. Waiver and Acknowledgment';
	String get waiver_body => 'Class action waiver: All disputes must be handled individually.\nLimitation period: Any claim must be filed within 1 year maximum.';
	String get contact_title => '15. Contact Information';
	String get contact_controller_label => 'Data Controller';
	String get contact_controller => 'Wayo, Dubai, UAE';
	String get contact_email_label => 'Email';
	String get contact_email => 'info@wayo.cloud';
...
// Path: cookie_policy
class TranslationsCookiePolicyEn {
	TranslationsCookiePolicyEn.internal(this._root);

	final Translations _root; // ignore: unused_field

	// Translations
	String get title => 'Cookie Policy';
	String get last_updated => 'Last updated: May 15, 2025';
	String get company_legal_name => 'AL BOUHOUTI SOFTWARE DESIGN COMPANY L.L.C';
	String get operator_intro => 'Operator of the Wayo Ads platform.';
	String get company_address => 'Al Barshaa 1, Dubai, Dubai, United Arab Emirates';
	String get support_label => 'Customer support';
	String get support_email => 'support@wayo.cloud';
	String get support_phone => '+971 542396643';
	String get back_home => 'Back to Home';
	String get intro_title => '1. Introduction';
	String get intro_body => 'This Cookie Policy explains how Wayo Ads uses cookies and similar tracking technologies when you visit our website. By using our platform, you agree to the use of cookies as described in this policy, subject to your consent preferences.';
	String get what_are_title => '2. What Are Cookies?';
	String get what_are_body => 'Cookies are small text files placed on your device (computer, tablet, or mobile) when you visit a website. They are widely used to make websites work efficiently, to remember your preferences, and to provide information to the site owners. Cookies may be \'session cookies\' (deleted when you close your browser) or \'persistent cookies\' (remain on your device for a set period or until you delete them).';
	String get types_title => '3. Types of Cookies We Use';
	String get types_essential_title => 'Essential Cookies';
	String get types_essential_body => 'These cookies are necessary for the website to function properly. They enable core functionality such as security, network management, and accessibility. You may disable these by changing your browser settings, but this may affect how the website functions.';
	String get types_analytics_title => 'Analytics Cookies';
	String get types_analytics_body => 'These cookies help us understand how visitors interact with our website by collecting and reporting information anonymously. We use Google Analytics to measure traffic and usage patterns. Analytics cookies are only set if you consent via our cookie banner.';
	String get types_preferences_title => 'Preference Cookies';
	String get types_preferences_body => 'These cookies allow the website to remember choices you make (such as your language preference or sidebar state) to provide a more personalized experience.';
	String get table_title => '4. Cookie Inventory';
	String get table_description => 'Below is a detailed list of cookies we may set on your device:';
	String get table_col_name => 'Cookie Name';
	String get table_col_purpose => 'Purpose';
	String get table_col_duration => 'Duration';
	String get row_cookie_consent_name => 'cookie_consent';
	String get row_cookie_consent_purpose => 'Stores your cookie consent decision (accepted, declined, or customized)';
	String get row_cookie_consent_duration => '1 year';
	String get row_cookie_preferences_name => 'cookie_preferences';
	String get row_cookie_preferences_purpose => 'Stores your customized cookie preferences (e.g., analytics toggle)';
	String get row_cookie_preferences_duration => '1 year';
	String get row_session_token_name => 'next-auth.session-token / __Secure-next-auth.session-token';
	String get row_session_token_purpose => 'Maintains your authenticated session';
	String get row_session_token_duration => 'Session';
	String get row_callback_url_name => 'next-auth.callback-url';
	String get row_callback_url_purpose => 'Stores the page to redirect to after signing in';
	String get row_callback_url_duration => 'Session';
	String get row_csrf_token_name => 'next-auth.csrf-token / __Host-next-auth.csrf-token';
	String get row_csrf_token_purpose => 'Protects against Cross-Site Request Forgery attacks';
	String get row_csrf_token_duration => 'Session';
	String get row_pkce_name => '__Secure-next-auth.pkce.code_verifier';
	String get row_pkce_purpose => 'Secures the OAuth authentication flow (PKCE)';
	String get row_pkce_duration => 'Session';
	String get row_oauth_state_name => 'oauth_state_id';
	String get row_oauth_state_purpose => 'References the OAuth flow state for secure social logins';
	String get row_oauth_state_duration => '10 minutes';
	String get row_oauth_reauth_name => 'oauth_force_reauth';
	String get row_oauth_reauth_purpose => 'Ensures a fresh authentication prompt for social logins';
	String get row_oauth_reauth_duration => '10 minutes';
	String get row_yt_pkce_name => '__yt_oauth_pkce';
	String get row_yt_pkce_purpose => 'Secures the YouTube OAuth connection flow';
	String get row_yt_pkce_duration => '10 minutes';
	String get row_locale_name => 'locale';
	String get row_locale_purpose => 'Remembers your language preference (English, French, or Arabic)';
	String get row_locale_duration => '1 year';
	String get row_sidebar_name => 'sidebar_state';
	String get row_sidebar_purpose => 'Remembers whether you collapsed or expanded the sidebar';
	String get row_sidebar_duration => '7 days';
	String get row_iab_dismissed_name => 'wayo_iab_dismissed';
	String get row_iab_dismissed_purpose => 'Remembers that you dismissed the in-app browser warning';
	String get row_iab_dismissed_duration => '12 hours';
	String get row_app_install_name => 'wayo_app_install_dismissed';
	String get row_app_install_purpose => 'Remembers that you dismissed the mobile app install prompt';
	String get row_app_install_duration => '7 days';
	String get row_analytics_name => '_ga, _ga_* (Google Analytics)';
	String get row_analytics_purpose => 'Collects anonymous usage statistics (pages visited, session duration, traffic sources). Only set with your consent.';
	String get row_analytics_duration => '2 years';
	String get row_stripe_name => 'Stripe Cookies';
	String get row_stripe_purpose => 'Used for payment processing, fraud detection, and checkout functionality';
	String get row_stripe_duration => 'Session to 1 year';
	String get manage_title => '5. Managing Your Cookie Preferences';
	String get manage_body => 'When you first visit our website, a cookie banner appears allowing you to accept all cookies, decline non-essential cookies, or customize your preferences. You can change your preferences at any time by clicking the \'Cookie Settings\' link in the website footer. Most web browsers also allow you to control cookies through their settings. You can typically: delete cookies already stored on your device; block cookies from being set; set preferences for specific websites; browse in private/incognito mode. Please note that blocking essential cookies may impair certain features of the website.';
	String get changes_title => '6. Changes to This Cookie Policy';
	String get changes_body => 'We may update this Cookie Policy from time to time to reflect changes in our practices or for other operational, legal, or regulatory reasons. We will post any changes on this page and update the \'Last updated\' date.';
	String get contact_title => '7. Contact Information';
	String get contact_body => 'If you have questions about our use of cookies or this Cookie Policy, please contact us at info@wayo.cloud.';
}
...
class TranslationsAppSettingsEn {
	...
	String get passkeys_manage_hint => 'Use passkeys to sign in quickly without a password.';
	String get passkeys_open_manage => 'Manage passkeys';
	String get passkeys_empty => 'No passkeys configured.';
	String get passkeys_count_one => '1 passkey';
	String passkeys_count_many({required Object count}) => '$count passkeys';
	String get passkeys_add => 'Add a passkey';
	String get passkeys_rename => 'Rename';
	String get passkeys_remove => 'Remove';
	String get passkeys_remove_title => 'Remove this passkey?';
	String get passkeys_remove_body => 'This passkey will no longer be usable to sign in to Wayo.';
	String get passkeys_remove_confirm => 'Remove';
	String get passkeys_remove_cancel => 'Cancel';
	String passkeys_created({required Object date}) => 'Created $date';
	String passkeys_last_used({required Object date}) => 'Last used: $date';
	String get passkeys_never_used => 'Never used';
	String get passkeys_rename_title => 'Rename passkey';
	String get passkeys_default_name => 'Passkey';
	String get passkeys_promote_title => 'Enable passkey sign-in';
	String get passkeys_promote_body => 'Sign in faster with your fingerprint, face or device lock.';
	String get passkeys_promote_create => 'Create a passkey';
	String get passkeys_promote_later => 'Not now';
	String get passkeys_created_ok => 'Passkey added';
	String get passkeys_error => 'Something went wrong. Please try again.';
	String get passkeys_already_title => 'Passkey already available';
	String get passkeys_already_body => 'A Wayo passkey is already saved on this device or with your credential provider. It appears in the list above. To add another, use a different provider (Google Password Manager, iCloud, security key, etc.).';
	String get passkeys_already_action => 'Got it';
	String get passkeys_stale_title => 'Replace the passkey on this device';
	String get passkeys_stale_body => 'Your phone still has an old Wayo passkey that is no longer linked to your account. Delete it in Samsung Pass or Google Password Manager (Settings → Passwords / Passkeys → preprodauth.wayo.ac or myaccount.wayo.ac), then tap “Add a passkey” again.';
	String get passkeys_limit_reached => 'You have reached the maximum number of passkeys for this account.';
	String get passkeys_last_lockout => 'This passkey is currently your last available sign-in method. Add another sign-in method before removing it.';
	String get passkeys_security_entry => 'Passkeys';
	String get passkeys_security_sub => 'Sign in without a password';
...
class TranslationsAdvertiserCampaignsCreateEn {
	...
	String get logo_pick => 'Upload brand logo';
	String get logo_change => 'Change';
	String get logo_remove => 'Remove';
	String get logo_reposition => 'Reposition';
	String get logo_uploading => 'Uploading…';
	String get logo_help => 'Landscape image (16:9) recommended, 1920×1080 px minimum. Appears as the hero banner on your campaign page. PNG, JPG or WebP. Max 2 MB.';
	...
	String get logo_crop_title => 'Position your campaign image';
	String get logo_crop_desc => 'Drag to reposition and zoom so the important part stays inside the 16:9 frame.';
	String get logo_crop_zoom => 'Zoom';
	String get logo_crop_hint => 'What you see in the frame is what creators will see on the campaign page and in Browse.';
	String get logo_crop_cancel => 'Cancel';
	String get logo_crop_apply => 'Apply crop';
	String get logo_crop_applying => 'Saving…';
	String get logo_crop_failed => 'Couldn\'t crop this image. Try another file.';
	String get logo_aspect_hint => '16:9 · object-cover';
...
extension on Translations {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'login.passkey_cta': return 'Continue with passkey';
			case 'login.passkey_preparing': return 'Preparing secure sign-in…';
			case 'login.passkey_canceled': return 'Passkey sign-in cancelled.';
			case 'login.passkey_not_found': return 'No passkey found for Wayo on this device. Use another sign-in method or create a passkey after signing in.';
			case 'login.passkey_unavailable': return 'Passkeys aren\'t available on this device.';
			case 'login.passkey_network': return 'Network error. Check your connection and try again.';
			case 'login.passkey_failed': return 'We couldn\'t sign you in with this passkey. Try again or use another sign-in method.';
			case 'login.passkey_interrupted': return 'Sign-in was interrupted. Please try again.';
			case 'login.passkey_missing_title': return 'No Wayo Ads passkey';
			case 'login.passkey_missing_body': return 'You haven\'t set up a passkey for this account yet. Sign in with Google, Apple or your password, then enable a passkey from Profile → Security → Passkeys.';
			case 'login.passkey_missing_primary': return 'Use another method';
			case 'login.passkey_missing_secondary': return 'Cancel';
			case 'login.passkey_created_title': return 'Passkey created';
			case 'login.passkey_created_body': return 'You can now use “Continue with passkey” to sign in to Wayo Ads.';
			case 'login.passkey_created_action': return 'Got it';
			...
			case 'login.web_session_title': return 'Account Already Active';
			case 'login.web_session_body': return 'This account is already active on another device. Do you want to disconnect the other device and sign in here?';
			...
			case 'advertiser_campaigns.create.logo_pick': return 'Upload brand logo';
			case 'advertiser_campaigns.create.logo_change': return 'Change';
			case 'advertiser_campaigns.create.logo_remove': return 'Remove';
			case 'advertiser_campaigns.create.logo_reposition': return 'Reposition';
			case 'advertiser_campaigns.create.logo_uploading': return 'Uploading…';
			case 'advertiser_campaigns.create.logo_help': return 'Landscape image (16:9) recommended, 1920×1080 px minimum. Appears as the hero banner on your campaign page. PNG, JPG or WebP. Max 2 MB.';
			...
			case 'advertiser_campaigns.create.logo_crop_title': return 'Position your campaign image';
			case 'advertiser_campaigns.create.logo_crop_desc': return 'Drag to reposition and zoom so the important part stays inside the 16:9 frame.';
			case 'advertiser_campaigns.create.logo_crop_zoom': return 'Zoom';
			case 'advertiser_campaigns.create.logo_crop_hint': return 'What you see in the frame is what creators will see on the campaign page and in Browse.';
			case 'advertiser_campaigns.create.logo_crop_cancel': return 'Cancel';
			case 'advertiser_campaigns.create.logo_crop_apply': return 'Apply crop';
			case 'advertiser_campaigns.create.logo_crop_applying': return 'Saving…';
			case 'advertiser_campaigns.create.logo_crop_failed': return 'Couldn\'t crop this image. Try another file.';
			case 'advertiser_campaigns.create.logo_aspect_hint': return '16:9 · object-cover';
			...
			case 'privacy_policy.operator_intro': return 'This website and the Wayo Ads platform are operated by:';
			case 'privacy_policy.company_address': return 'Al Barshaa 1, Dubai, Dubai, United Arab Emirates';
			case 'privacy_policy.support_label': return 'Customer support';
			...
			case 'privacy_policy.data_intro': return 'We only collect data that is necessary, in accordance with applicable law and, where relevant, the GDPR.';
			case 'privacy_policy.data_advertisers_title': return 'For Advertisers';
			case 'privacy_policy.data_advertisers_body': return 'Identification and contact data: Company name, email address, phone number.\nProfile: Business logo (if provided), company description.\nCampaigns: Campaign content, budgets, targeting criteria, analytics data.';
			case 'privacy_policy.data_creators_title': return 'For Creators';
			case 'privacy_policy.data_creators_body': return 'Identification and contact data: Name, email address, phone number.\nProfile: Profile photo (if provided), biography, expertise, social media links.\nContent: Videos, posts, and materials you upload.\nUsage data: Interactions with the platform, engagement statistics, earnings data.';
			case 'privacy_policy.data_technical_title': return 'Technical Information (All Users)';
			case 'privacy_policy.data_technical_body': return 'Technical data: IP address, browser type and version, device type, operating system, session identifiers, timestamps, pages visited, clicks, referrers.\nCookies and similar technologies: See section 8 (Cookies).';
			case 'privacy_policy.data_payment_title': return 'Payment Data';
			case 'privacy_policy.data_payment_body': return 'Transactions: Amounts, currency, date, payment method, billing address.';
			case 'privacy_policy.data_payment_note': return 'Important: Card data is processed exclusively by our payment provider (Stripe). Wayo does not store credit card information.';
			...
			case 'privacy_policy.legal_bases_body': return 'Depending on the case, we rely on: Your consent (e.g., non-essential cookies, newsletters). Performance of a contract or pre-contractual measures (e.g., registration, billing). Compliance with a legal obligation (e.g., invoice retention). Our legitimate interest (e.g., security, service improvement).';
			case 'privacy_policy.sharing_title': return '5. Sharing Your Information';
			case 'privacy_policy.sharing_body': return 'Wayo does not sell your personal data. Limited sharing may occur with: Essential service providers (payment processors, hosting providers, emailing tools, analytics). Legal reasons: If required by law or in response to a legitimate request from a competent authority.';
			case 'privacy_policy.security_title': return '6. Data Security';
			case 'privacy_policy.security_body': return 'TLS/HTTPS encryption for data in transit.\nAccess controls based on need-to-know.\nRegular backups and restoration procedures.\nSecurity updates and periodic audits.\nLogging and detection of abnormal activities.';
			case 'privacy_policy.content_title': return '7. User Responsibilities and Content Protection';
			case 'privacy_policy.content_body': return 'Respect the intellectual property rights of creators and Wayo. Do not copy, share, redistribute, or resell content without authorization. Any violation may result in account suspension and, if applicable, legal action.';
			case 'privacy_policy.cookies_title': return '8. Cookies and Tracking Technologies';
			case 'privacy_policy.cookies_body': return 'Essential cookies (site functionality, security, session).\nAnalytical cookies (e.g., Google Analytics) for audience measurement.\nNon-essential cookies are only set with your consent via a cookie banner on your first visit.';
			...
			case 'privacy_policy.contact_controller_label': return 'Data Controller';
			case 'privacy_policy.contact_controller': return 'Wayo, Dubai, UAE';
			case 'privacy_policy.contact_email_label': return 'Email';
			case 'privacy_policy.contact_email': return 'info@wayo.cloud';
			case 'privacy_policy.contact_address_label': return 'Address';
			case 'privacy_policy.contact_address': return 'R320 Umm Hurair 2, Dubai, UAE';
			case 'terms_and_conditions.title': return 'Terms and Conditions';
			case 'terms_and_conditions.last_updated': return 'Last updated: October 7, 2025';
			case 'terms_and_conditions.company_legal_name': return 'AL BOUHOUTI SOFTWARE DESIGN COMPANY L.L.C';
			case 'terms_and_conditions.operator_intro': return 'This website and the Wayo Ads platform are operated by:';
			case 'terms_and_conditions.company_address': return 'Al Barshaa 1, Dubai, Dubai, United Arab Emirates';
			case 'terms_and_conditions.support_label': return 'Customer support';
			...
			case 'terms_and_conditions.back_home': return 'Back to Home';
			case 'terms_and_conditions.intro_title': return '1. Introduction';
			case 'terms_and_conditions.intro_body': return 'Welcome to Wayo Ads, your online platform connecting advertisers with content creators. By accessing our website and/or mobile application, you agree to comply with these terms and conditions. Please read them carefully, as they define your rights and obligations as a user.';
			case 'terms_and_conditions.definitions_title': return '2. Definitions';
			case 'terms_and_conditions.definitions_body': return 'Wayo — The entire set of advertising and creator marketplace services available through the website and mobile application.\nUser — Any person (advertiser, creator, or organization) holding an account on the platform.\nContent — All documents, videos, advertisements, campaigns, and other materials accessible via the platform.\nUsage rights — Access and use rights to the content are strictly personal, private, and non-transferable.';
			case 'terms_and_conditions.access_title': return '3. Access and Use';
			case 'terms_and_conditions.access_body': return 'The user must create an account by providing accurate and up-to-date information. The user is responsible for keeping their login details confidential. Any unauthorized use must be reported immediately.';
			case 'terms_and_conditions.content_protection_title': return '4. Content Protection and Use';
			case 'terms_and_conditions.content_protection_body': return 'All materials and content remain the intellectual property of their respective owners. Reproduction, distribution, sale, or sharing of content is strictly prohibited. Any violation will result in immediate suspension of the account and may lead to legal action.';
			case 'terms_and_conditions.features_title': return '5. Features and Services';
			case 'terms_and_conditions.features_body': return 'Our platform offers various features including campaign creation, creator marketplace, analytics dashboards, payment processing, and communication tools. Users agree to use these services responsibly and in accordance with these terms.';
			case 'terms_and_conditions.support_title': return '6. Technical Support and Maintenance';
			case 'terms_and_conditions.support_body': return 'Support is available Monday to Friday, from 9:00 AM to 5:00 PM (UTC+1) via email or integrated chat. Estimated response time is 24 to 48 hours. Users will be notified in advance of any scheduled downtime.';
			case 'terms_and_conditions.rights_title': return '7. User Rights and Responsibilities';
			case 'terms_and_conditions.rights_body': return 'Advertisers have the right to create and manage campaigns, access analytics, and connect with creators. Creators have the right to browse campaigns, accept offers, and receive payment for completed work. All users must act in good faith and comply with platform rules.';
			case 'terms_and_conditions.prohibited_title': return 'Prohibited Behavior';
			case 'terms_and_conditions.prohibited_body': return 'Fraud (e.g., fake views, click fraud), illegal, offensive, or harmful content, spamming, impersonation, and any activity that undermines the integrity of the platform are strictly prohibited. Any breach may result in permanent suspension and legal action.';
			case 'terms_and_conditions.ip_title': return '8. Intellectual Property';
			case 'terms_and_conditions.ip_body': return 'All trademarks, logos, designs, code, and other intellectual property on the platform are protected by copyright law and international conventions. Users retain ownership of content they create but grant Wayo a non-exclusive license to host, display, and make it accessible.';
			case 'terms_and_conditions.privacy_title': return '9. Personal Data';
			case 'terms_and_conditions.privacy_body': return 'The collection and processing of data are carried out in accordance with our Privacy Policy. Users have the right to access, correct, and delete their personal data. For more information, please review our Privacy Policy.';
			case 'terms_and_conditions.view_privacy_policy': return 'View Privacy Policy';
			case 'terms_and_conditions.liability_title': return '10. Limitation of Liability';
			case 'terms_and_conditions.liability_body': return 'Wayo shall not be held responsible for: the quality or relevance of content provided by users, disputes between advertisers and creators, service interruptions, data loss, or technical issues. Wayo\'s liability is limited to the amount of fees paid for the service.';
			case 'terms_and_conditions.termination_title': return '11. Termination';
			case 'terms_and_conditions.termination_body': return 'Wayo may suspend or terminate an account in case of violation of these terms. Users may close their account through the platform interface at any time. Upon termination, all rights and access will be immediately revoked.';
			case 'terms_and_conditions.governing_law_title': return '12. Governing Law and Dispute Resolution';
			case 'terms_and_conditions.governing_law_body': return 'Governing law: The laws in force in the United Arab Emirates. Both parties agree to seek amicable resolution before initiating legal proceedings.';
			case 'terms_and_conditions.amendments_title': return '13. Amendments to the Terms';
			case 'terms_and_conditions.amendments_body': return 'Wayo may modify these terms at any time. Users will be notified of any changes, which will take effect 15 days after notification.';
			case 'terms_and_conditions.waiver_title': return '14. Waiver and Acknowledgment';
			case 'terms_and_conditions.waiver_body': return 'Class action waiver: All disputes must be handled individually.\nLimitation period: Any claim must be filed within 1 year maximum.';
			case 'terms_and_conditions.contact_title': return '15. Contact Information';
			case 'terms_and_conditions.contact_controller_label': return 'Data Controller';
			case 'terms_and_conditions.contact_controller': return 'Wayo, Dubai, UAE';
			case 'terms_and_conditions.contact_email_label': return 'Email';
			case 'terms_and_conditions.contact_email': return 'info@wayo.cloud';
			case 'terms_and_conditions.contact_address_label': return 'Address';
			case 'terms_and_conditions.contact_address': return 'R320 Umm Hurair 2, Dubai, UAE';
			case 'cookie_policy.title': return 'Cookie Policy';
			case 'cookie_policy.last_updated': return 'Last updated: May 15, 2025';
			case 'cookie_policy.company_legal_name': return 'AL BOUHOUTI SOFTWARE DESIGN COMPANY L.L.C';
			case 'cookie_policy.operator_intro': return 'Operator of the Wayo Ads platform.';
			case 'cookie_policy.company_address': return 'Al Barshaa 1, Dubai, Dubai, United Arab Emirates';
			case 'cookie_policy.support_label': return 'Customer support';
			case 'cookie_policy.support_email': return 'support@wayo.cloud';
			case 'cookie_policy.support_phone': return '+971 542396643';
			case 'cookie_policy.back_home': return 'Back to Home';
			case 'cookie_policy.intro_title': return '1. Introduction';
			case 'cookie_policy.intro_body': return 'This Cookie Policy explains how Wayo Ads uses cookies and similar tracking technologies when you visit our website. By using our platform, you agree to the use of cookies as described in this policy, subject to your consent preferences.';
			case 'cookie_policy.what_are_title': return '2. What Are Cookies?';
			case 'cookie_policy.what_are_body': return 'Cookies are small text files placed on your device (computer, tablet, or mobile) when you visit a website. They are widely used to make websites work efficiently, to remember your preferences, and to provide information to the site owners. Cookies may be \'session cookies\' (deleted when you close your browser) or \'persistent cookies\' (remain on your device for a set period or until you delete them).';
			case 'cookie_policy.types_title': return '3. Types of Cookies We Use';
			case 'cookie_policy.types_essential_title': return 'Essential Cookies';
			case 'cookie_policy.types_essential_body': return 'These cookies are necessary for the website to function properly. They enable core functionality such as security, network management, and accessibility. You may disable these by changing your browser settings, but this may affect how the website functions.';
			case 'cookie_policy.types_analytics_title': return 'Analytics Cookies';
			case 'cookie_policy.types_analytics_body': return 'These cookies help us understand how visitors interact with our website by collecting and reporting information anonymously. We use Google Analytics to measure traffic and usage patterns. Analytics cookies are only set if you consent via our cookie banner.';
			case 'cookie_policy.types_preferences_title': return 'Preference Cookies';
			case 'cookie_policy.types_preferences_body': return 'These cookies allow the website to remember choices you make (such as your language preference or sidebar state) to provide a more personalized experience.';
			case 'cookie_policy.table_title': return '4. Cookie Inventory';
			case 'cookie_policy.table_description': return 'Below is a detailed list of cookies we may set on your device:';
			case 'cookie_policy.table_col_name': return 'Cookie Name';
			case 'cookie_policy.table_col_purpose': return 'Purpose';
			case 'cookie_policy.table_col_duration': return 'Duration';
			case 'cookie_policy.row_cookie_consent_name': return 'cookie_consent';
			case 'cookie_policy.row_cookie_consent_purpose': return 'Stores your cookie consent decision (accepted, declined, or customized)';
			case 'cookie_policy.row_cookie_consent_duration': return '1 year';
			case 'cookie_policy.row_cookie_preferences_name': return 'cookie_preferences';
			case 'cookie_policy.row_cookie_preferences_purpose': return 'Stores your customized cookie preferences (e.g., analytics toggle)';
			case 'cookie_policy.row_cookie_preferences_duration': return '1 year';
			case 'cookie_policy.row_session_token_name': return 'next-auth.session-token / __Secure-next-auth.session-token';
			case 'cookie_policy.row_session_token_purpose': return 'Maintains your authenticated session';
			...
			case 'cookie_policy.row_callback_url_purpose': return 'Stores the page to redirect to after signing in';
			...
			case 'cookie_policy.row_csrf_token_purpose': return 'Protects against Cross-Site Request Forgery attacks';
			...
			case 'cookie_policy.row_pkce_purpose': return 'Secures the OAuth authentication flow (PKCE)';
			case 'cookie_policy.row_pkce_duration': return 'Session';
			case 'cookie_policy.row_oauth_state_name': return 'oauth_state_id';
			case 'cookie_policy.row_oauth_state_purpose': return 'References the OAuth flow state for secure social logins';
			...
			case 'cookie_policy.row_oauth_reauth_purpose': return 'Ensures a fresh authentication prompt for social logins';
			case 'cookie_policy.row_oauth_reauth_duration': return '10 minutes';
			case 'cookie_policy.row_yt_pkce_name': return '__yt_oauth_pkce';
			case 'cookie_policy.row_yt_pkce_purpose': return 'Secures the YouTube OAuth connection flow';
			case 'cookie_policy.row_yt_pkce_duration': return '10 minutes';
			case 'cookie_policy.row_locale_name': return 'locale';
			case 'cookie_policy.row_locale_purpose': return 'Remembers your language preference (English, French, or Arabic)';
			case 'cookie_policy.row_locale_duration': return '1 year';
			case 'cookie_policy.row_sidebar_name': return 'sidebar_state';
			case 'cookie_policy.row_sidebar_purpose': return 'Remembers whether you collapsed or expanded the sidebar';
			case 'cookie_policy.row_sidebar_duration': return '7 days';
			case 'cookie_policy.row_iab_dismissed_name': return 'wayo_iab_dismissed';
			case 'cookie_policy.row_iab_dismissed_purpose': return 'Remembers that you dismissed the in-app browser warning';
			case 'cookie_policy.row_iab_dismissed_duration': return '12 hours';
			case 'cookie_policy.row_app_install_name': return 'wayo_app_install_dismissed';
			case 'cookie_policy.row_app_install_purpose': return 'Remembers that you dismissed the mobile app install prompt';
			case 'cookie_policy.row_app_install_duration': return '7 days';
			case 'cookie_policy.row_analytics_name': return '_ga, _ga_* (Google Analytics)';
			case 'cookie_policy.row_analytics_purpose': return 'Collects anonymous usage statistics (pages visited, session duration, traffic sources). Only set with your consent.';
			case 'cookie_policy.row_analytics_duration': return '2 years';
			case 'cookie_policy.row_stripe_name': return 'Stripe Cookies';
			case 'cookie_policy.row_stripe_purpose': return 'Used for payment processing, fraud detection, and checkout functionality';
			case 'cookie_policy.row_stripe_duration': return 'Session to 1 year';
			case 'cookie_policy.manage_title': return '5. Managing Your Cookie Preferences';
			case 'cookie_policy.manage_body': return 'When you first visit our website, a cookie banner appears allowing you to accept all cookies, decline non-essential cookies, or customize your preferences. You can change your preferences at any time by clicking the \'Cookie Settings\' link in the website footer. Most web browsers also allow you to control cookies through their settings. You can typically: delete cookies already stored on your device; block cookies from being set; set preferences for specific websites; browse in private/incognito mode. Please note that blocking essential cookies may impair certain features of the website.';
			case 'cookie_policy.changes_title': return '6. Changes to This Cookie Policy';
			case 'cookie_policy.changes_body': return 'We may update this Cookie Policy from time to time to reflect changes in our practices or for other operational, legal, or regulatory reasons. We will post any changes on this page and update the \'Last updated\' date.';
			case 'cookie_policy.contact_title': return '7. Contact Information';
			case 'cookie_policy.contact_body': return 'If you have questions about our use of cookies or this Cookie Policy, please contact us at info@wayo.cloud.';

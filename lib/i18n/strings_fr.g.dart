...
class _TranslationsLoginFr extends TranslationsLoginEn {
	...
	@override String get passkey_cta => 'Continuer avec une clé d’accès';
	@override String get passkey_preparing => 'Préparation de la connexion sécurisée…';
	@override String get passkey_canceled => 'Connexion par clé d’accès annulée.';
	@override String get passkey_not_found => 'Aucune clé d’accès Wayo sur cet appareil. Utilisez une autre méthode ou créez une clé d’accès après connexion.';
	@override String get passkey_unavailable => 'Les clés d’accès ne sont pas disponibles sur cet appareil.';
	@override String get passkey_network => 'Erreur réseau. Vérifiez votre connexion et réessayez.';
	@override String get passkey_failed => 'Impossible de vous connecter avec cette clé d’accès. Réessayez ou utilisez une autre méthode.';
	@override String get passkey_interrupted => 'La connexion a été interrompue. Réessayez.';
	@override String get passkey_missing_title => 'Aucune clé d’accès Wayo Ads';
	@override String get passkey_missing_body => 'Vous n’avez pas encore configuré de clé d’accès pour ce compte. Connectez-vous avec Google, Apple ou votre mot de passe, puis activez une clé d’accès depuis Profil → Sécurité → Clés d’accès.';
	@override String get passkey_missing_primary => 'Utiliser une autre méthode';
	@override String get passkey_missing_secondary => 'Annuler';
	@override String get passkey_created_title => 'Clé d’accès ajoutée';
	@override String get passkey_created_body => 'Vous pouvez maintenant utiliser cette clé d’accès pour vous connecter à votre compte Wayo.';
	@override String get passkey_created_action => 'Compris';
...
class _TranslationsAppSettingsFr extends TranslationsAppSettingsEn {
	...
	@override String get passkeys_manage_hint => 'Utilisez des clés d’accès pour vous connecter rapidement et sans mot de passe.';
	@override String get passkeys_open_manage => 'Gérer les passkeys';
	@override String get passkeys_empty => 'Aucune clé d’accès configurée.';
	@override String get passkeys_count_one => '1 clé d’accès';
	@override String passkeys_count_many({required Object count}) => '$count clés d’accès';
	@override String get passkeys_add => 'Ajouter une clé d’accès';
	@override String get passkeys_rename => 'Renommer';
	@override String get passkeys_remove => 'Supprimer';
	@override String get passkeys_remove_title => 'Supprimer cette clé d’accès ?';
	@override String get passkeys_remove_body => 'Cette clé d’accès ne pourra plus être utilisée pour vous connecter à Wayo.';
	@override String get passkeys_remove_confirm => 'Supprimer';
	@override String get passkeys_remove_cancel => 'Annuler';
	@override String passkeys_created({required Object date}) => 'Créée le $date';
	@override String passkeys_last_used({required Object date}) => 'Dernière utilisation : $date';
	@override String get passkeys_never_used => 'Jamais utilisée';
	@override String get passkeys_rename_title => 'Renommer la clé d’accès';
	@override String get passkeys_default_name => 'Clé d’accès';
	@override String get passkeys_promote_title => 'Activez la connexion par clé d’accès';
	@override String get passkeys_promote_body => 'Connectez-vous plus rapidement avec votre empreinte, votre visage ou le verrouillage de votre appareil.';
	@override String get passkeys_promote_create => 'Créer une clé d’accès';
	@override String get passkeys_promote_later => 'Plus tard';
	@override String get passkeys_created_ok => 'Clé d’accès ajoutée';
	@override String get passkeys_error => 'Une erreur s’est produite. Réessayez.';
	@override String get passkeys_already_title => 'Clé d’accès déjà disponible';
	@override String get passkeys_already_body => 'Une clé d’accès Wayo est déjà enregistrée sur cet appareil ou chez votre fournisseur. Elle apparaît dans la liste ci-dessus. Pour en ajouter une autre, utilisez un autre fournisseur (Google Password Manager, iCloud, clé physique, etc.).';
	@override String get passkeys_already_action => 'Compris';
	@override String get passkeys_stale_title => 'Clé d’accès à remplacer sur l’appareil';
	@override String get passkeys_stale_body => 'Votre téléphone a encore une ancienne clé pour Wayo, mais elle n’est plus liée à votre compte. Supprimez-la dans Samsung Pass ou Google Password Manager (Paramètres → Mots de passe / Clés d’accès → preprodauth.wayo.ac ou myaccount.wayo.ac), puis appuyez à nouveau sur « Ajouter une clé d’accès ».';
	@override String get passkeys_limit_reached => 'Vous avez atteint le nombre maximum de clés d’accès pour ce compte.';
	@override String get passkeys_last_lockout => 'Cette clé d’accès est actuellement votre dernière méthode de connexion disponible. Ajoutez une autre méthode de connexion avant de la supprimer.';
	@override String get passkeys_security_entry => 'Clés d’accès';
	@override String get passkeys_security_sub => 'Connexion sans mot de passe';
...
class _TranslationsAdvertiserCampaignsCreateFr extends TranslationsAdvertiserCampaignsCreateEn {
	...
	@override String get logo_section => 'Logo de marque (optionnel)';
	@override String get logo_pick => 'Uploader le logo';
	@override String get logo_change => 'Changer';
	@override String get logo_remove => 'Supprimer';
	@override String get logo_reposition => 'Repositionner';
	@override String get logo_uploading => 'Envoi…';
	@override String get logo_help => 'Image paysage (16:9) recommandée, 1920×1080 px minimum. S\'affiche comme bannière principale sur votre page de campagne. PNG, JPG ou WebP. Max 2 Mo.';
	@override String get logo_too_large => 'Le logo doit faire 2 Mo ou moins.';
	@override String get logo_upload_error => 'Échec de l\'envoi du logo';
	@override String get logo_pick_error => 'Impossible de lire l\'image sélectionnée';
	@override String get logo_crop_title => 'Positionnez l’image de campagne';
	@override String get logo_crop_desc => 'Faites glisser et zoomez pour garder la partie importante dans le cadre 16:9.';
	@override String get logo_crop_zoom => 'Agrandir';
	@override String get logo_crop_hint => 'Ce que vous voyez dans le cadre est ce que les créateurs verront sur la page campagne et dans Browse.';
	@override String get logo_crop_cancel => 'Annuler';
	@override String get logo_crop_apply => 'Appliquer';
	@override String get logo_crop_applying => 'Enregistrement…';
	@override String get logo_crop_failed => 'Impossible de recadrer cette image. Essayez un autre fichier.';
	@override String get logo_aspect_hint => '16:9 · object-cover';
}
...
extension on TranslationsFr {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'login.passkey_cta': return 'Continuer avec une clé d’accès';
			case 'login.passkey_preparing': return 'Préparation de la connexion sécurisée…';
			case 'login.passkey_canceled': return 'Connexion par clé d’accès annulée.';
			case 'login.passkey_not_found': return 'Aucune clé d’accès Wayo sur cet appareil. Utilisez une autre méthode ou créez une clé d’accès après connexion.';
			case 'login.passkey_unavailable': return 'Les clés d’accès ne sont pas disponibles sur cet appareil.';
			case 'login.passkey_network': return 'Erreur réseau. Vérifiez votre connexion et réessayez.';
			case 'login.passkey_failed': return 'Impossible de vous connecter avec cette clé d’accès. Réessayez ou utilisez une autre méthode.';
			case 'login.passkey_interrupted': return 'La connexion a été interrompue. Réessayez.';
			case 'login.passkey_missing_title': return 'Aucune clé d’accès Wayo Ads';
			case 'login.passkey_missing_body': return 'Vous n’avez pas encore configuré de clé d’accès pour ce compte. Connectez-vous avec Google, Apple ou votre mot de passe, puis activez une clé d’accès depuis Profil → Sécurité → Clés d’accès.';
			case 'login.passkey_missing_primary': return 'Utiliser une autre méthode';
			case 'login.passkey_missing_secondary': return 'Annuler';
			case 'login.passkey_created_title': return 'Clé d’accès créée';
			case 'login.passkey_created_body': return 'Vous pouvez désormais utiliser « Continuer avec une clé d’accès » pour vous connecter à Wayo Ads.';
			case 'login.passkey_created_action': return 'Compris';
